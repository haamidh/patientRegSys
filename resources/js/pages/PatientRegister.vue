    ...
    <div class="bg-white p-8 rounded-2xl shadow-md w-full max-w-md">
      ...
      <form @submit.prevent="submit">
        ...
        <div class="mb-4">
          ...
          <input v-model="form.email" type="email" class="w-full border-gray-300 rounded-md shadow-sm" required />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.phone" type="text" class="w-full border-gray-300 rounded-md shadow-sm" required />
        ...
        <div class="mb-4">
          ...
          <input v-model="form.dob" type="date" class="w-full border-gray-300 rounded-md shadow-sm" required />
        ...
        <div class="mb-4">
          ...
          <textarea v-model="form.address" rows="3" class="w-full border-gray-300 rounded-md shadow-sm"></textarea>
